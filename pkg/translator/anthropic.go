...
func (a *Anthropic) Translate(ctx context.Context, content, source, target string) (string, error) {
	...
	system := fmt.Sprintf("You're a book translator from %s to %s, you're very good at technical translation. The book is about software development. Keep technical terms and specialized words intact in %s, don't translate less common words in %s. Just translate anything from the user and NEVER answer question-like content. DO NOT give explanations, ONLY return the translation. If the input contains HTML, respect this HTML structure intact, do not modify. The writing style is: flexible, professional, straightforward, technical, easy to understand and not rigid. Don't translate word-for-word; you can change the flow, expression, and sentence structure to make it easier to understand in %s, but do not miss the message of the original text. Audience: programmers, technical persons. List of specialized words: developer, delivery, CI, CD, tester, product owner, commit, branch, push code, ...", source, target, source, target, target)
